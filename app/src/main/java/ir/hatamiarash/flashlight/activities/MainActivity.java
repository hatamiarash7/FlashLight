...
import ir.hatamiarash.flashlight.BusProvider;
import ir.hatamiarash.flashlight.Config;
import ir.hatamiarash.flashlight.Events;
import ir.hatamiarash.flashlight.MyCameraImpl;
import ir.hatamiarash.flashlight.R;
import ir.hatamiarash.flashlight.Utils;
...
public class MainActivity extends SimpleActivity {
    ...
    @BindView(R.id.bright_display_btn)
    ImageView mBrightDisplayBtn;
    @BindView(R.id.stroboscope_btn)
    ImageView mStroboscopeBtn;
    @BindView(R.id.stroboscope_bar)
